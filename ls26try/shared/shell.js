...
(() => {
  ...
  if(!document.querySelector('script[data-ls26-settings]')){
    ...
    settingsScript.src=url('shared/app-settings.js?v=20260924-session-controls2');
  ...
  function mountFullscreen(){
    ...
    function sync(){
      ...
      button.innerHTML=`<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="${active?'M3 8h5V3M16 3v5h5M21 16h-5v5M8 21v-5H3':'M8 3H3v5M16 3h5v5M21 16v5h-5M8 21H3v-5'}"/></svg><span class="ls26-fullscreen-label">${active?'Exit Fullscreen':'Fullscreen'}</span>`;
    }
