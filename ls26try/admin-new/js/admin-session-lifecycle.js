 ...
 * admin-new/js/admin-session-lifecycle.js — preserved application behaviour and compatibility support.
...
(() => {
  ...
  function startLiveSessionSnapshots(sessionId) {
    // Disabled: authoritative collections remain live; session archival is done
    // when END PERFORMANCE runs, avoiding duplicate realtime listeners/writes.
    clearLiveSync();
  }
