(() => {
  ...
  function socialIcon(label) {
    const icons = {
      FACEBOOK: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13.7 22v-8.1h2.7l.4-3.2h-3.1V8.6c0-.9.3-1.6 1.6-1.6H17V4.1c-.3 0-1.3-.1-2.5-.1-2.5 0-4.2 1.5-4.2 4.4v2.4H7.5v3.2h2.8V22h3.4z"/></svg>`,
      ...
      TIKTOK: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M16.7 2c.3 2.2 1.6 3.6 3.8 3.8v3.1a8.4 8.4 0 0 1-3.8-1.1v6.4a7.1 7.1 0 1 1-6.1-7v3.2a4 4 0 1 0 2.9 3.8V2h3.2z"/></svg>`,
  ...
  function renderSocials() {
    ...
    box.innerHTML = links.length
      ? links.map(([label,url]) => `<a class="social-link ${label === "EMAIL" ? "email" : ""}" href="${esc(url)}" target="_blank" rel="noopener" aria-label="${label}" title="${label}">${socialIcon(label)}</a>`).join("")
