/* Copyright © 2026 Roxanna. db/livekaraokesuite.js — preserved site configuration / asset support. */
(function () {
  "use strict";
  window.SITE_FIREBASE_CONFIG = {
  ...
  window.SITE_FIREBASE_PROJECT = "LIVEKARAOKESUITE";
})();
